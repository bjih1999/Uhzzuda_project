...
y_train = np.array(y_trainTemp[:][6])
...
print("Accuracy = ", accuracy_score(y_testTemp[:][6], pred))
print("Precision = ", precision_score(y_testTemp[:][6], pred, average='macro'))
print("Recall = ", recall_score(y_testTemp[:][6], pred, average='micro'))
...
with open('classifier/decision_tree_2102_prefessor+.csv','w', newline='') as f:
