...
GB_classifier = GradientBoostingClassifier(learning_rate=0.075)

training_data, validation_data , training_labels, validation_labels = \
    train_test_split(df_data, df_labels, test_size = 0.1, random_state = 52)

GB_classifier.fit(training_data, training_labels[:][9])
...
count = 0
with open('classifier/GBClassifier_class+_learning75e-3.csv', 'w', newline='') as ffff:
