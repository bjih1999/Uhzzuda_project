...
'''
doc2vec_model = Doc2Vec(documents, vector_size=300, window=10, min_count=70, workers=4)
doc2vec_model.save('./doc2vec/8.model')
'''

doc2vec_model = Doc2Vec(documents, vector_size=300, window=10, min_count=70, workers=4)
doc2vec_model.save('./doc2vec/add1.model')

doc2vec_model = Doc2Vec(documents, vector_size=300, window=10, min_count=50, workers=4)
doc2vec_model.save('./doc2vec/add2.model')

doc2vec_model = Doc2Vec(documents, vector_size=300, window=10, min_count=100, workers=4)
doc2vec_model.save('./doc2vec/add3.model')
