...
reviewlist = []
sentences = []
with open('rhino/reviewlist.csv', 'r') as reviewfile:
...
sent_file = open('rhino/review_sent_rhino_1126_4PM.csv', 'w', newline='')
sent_writer = csv.writer(sent_file)

with open('rhino/preprocessed_review_rhino_1126_4PM.csv', 'w', newline='') as output_file:
    ...
    for idx, review in enumerate(reviewlist[:100]):
        ...
        for morph in morphs: # morph[1].startswith('M') == False and
            if morph[1] != 'VCP' and morph[1] != 'MAJ' and morph[1] != 'IC' and morph[1].startswith('J') == False and morph[1] != 'EP' and morph[1] != 'EC' and morph[1] != 'EF' and morph[1] != 'ETM' and morph[1] != 'ETN' and morph[1] != 'SP' and morph[1] != 'SE' and morph[1] != 'SF' and morph[0] != '':
                sent.append(morph[0])
            if morph[1] != 'SF':
                sent_str.append(morph[0])

            if morph[1] != 'VCP' and morph[1] != 'MAJ' and morph[1] != 'IC' and morph[1].startswith('J') == False and morph[1] != 'EP' and morph[1] != 'EC' and morph[1] != 'ETM' and morph[1] != 'ETN' and morph[1] != 'SP' and morph[1] != 'SE' and morph[1] != 'SF' and morph[0] != '':
                pos = True
            if (morph[1] == 'ETN' and '음' in morph[0] or 'ㅁ' in morph[0]) or (morph[1] == 'EF' and (morph[0].endswith('다') or morph[0].endswith('요'))) or morph[1] == 'SF' or morph[1] == 'SE':
                if len(sent) > 1 and pos == True:
                    preprocessed_sent_str.append(sent_str)
                    print('sent : ', str(' '.join(sent_str)))
                    sent_writer.writerow([str(' '.join(sent_str))])
                    sent_str = []
                    pos = False
